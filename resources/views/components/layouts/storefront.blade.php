...
<head>
    ...
    <meta name="description" content="Way Kopi menjual kopi robusta yang dipanen langsung oleh petani di Lampung, Indonesia. Nikmati cita rasa bold, autentik, direct-to-consumer.">
...
<body class="bg-[var(--color-bg-base)] text-[var(--color-text-primary)] font-body antialiased flex flex-col min-h-full selection:bg-[var(--color-accent-gold)] selection:text-black">
    ...
    <!-- Footer -->
    <footer class="bg-[var(--color-bg-surface)] border-t border-[var(--color-coffee-brown)] mt-20">
        <div class="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-14">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 font-mono text-xs">
                <!-- Col 1: Logo & About -->
                <div class="space-y-3">
                ...
                <div class="space-y-3">
                    ...
                    <ul class="space-y-2 text-[var(--color-text-muted)]">
                        <li><a href="{{ route('products.index') }}" class="hover:text-[var(--color-accent-gold)]">Katalog Produk Kopi</a></li>
                        <li><a href="{{ route('about.index') }}" class="hover:text-[var(--color-accent-gold)]">Cerita Petani Lampung</a></li>
                        <li><a href="{{ route('blog.index') }}" class="hover:text-[var(--color-accent-gold)]">Jurnal & Panduan Seduh</a></li>
                        <li><a href="{{ route('cart.index') }}" class="hover:text-[var(--color-accent-gold)]">Keranjang Belanja</a></li>
                    </ul>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <ul class="space-y-2 text-[var(--color-text-muted)]">
                        ...
                        <li>Gudang Pengiriman: Tajurhalang, Kab. Bogor, Jawa Barat</li>
                        <li>Mitra Ekspedisi: Biteship (JNE, Sicepat, J&T, Lion, Paxel)</li>
                    </ul>
                </div>
