    ...
    <div class="flex flex-1 relative min-h-screen">
        ...
        <aside :class="{ 'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen }"
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 text-sm font-medium font-mono">
                ...
                <a href="{{ route('blog.index') }}" class="flex items-center px-3.5 py-2.5 rounded-[var(--radius-sm)] transition-colors text-[var(--color-text-muted)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-bg-base)]">
                    <span class="mr-2.5">📰</span> Jurnal & Blog
                </a>
            </nav>
